...
var f=e("nofactor"),d=function(a){this.nodeFactory=a=a||f["default"];this.start=a.createTextNode("");this.end=a.createTextNode("");this.visible=!0;a=a.createElement("div");a.appendChild(this.start);a.appendChild(this.end)},d=h(d,{__isLoafSection:!0,replace:function(a){a.parentNode.insertBefore(this.toFragment(),a);a.parentNode.removeChild(a)},show:function(){if(!this._detached)return this;this.append.apply(this,this._detached.getInnerChildNodes());this._detached=void 0;this.visibile=!0;return this},
